...
train_res_json = data_process.img_label_process('./input/train_data',True,'train')
...
lora_config = LoraConfig(
    ...
    lora_dropout = 0.05,
    bias = "none",
    target_modules = ["q_proj", "v_proj"],  # 只针对关键层
    task_type = "CAUSAL_LM"
)
...
model = LlavaNextForConditionalGeneration.from_pretrained(
    "./model",trust_remote_code = model_config.trust_remote_code, **model_kwargs
)
